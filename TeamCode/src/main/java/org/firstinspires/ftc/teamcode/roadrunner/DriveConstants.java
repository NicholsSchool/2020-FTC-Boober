...
public class DriveConstants {
    ...
    public static final boolean RUN_USING_ENCODER = true;
                                                                        // Initial for fun testing: 35, 1.5, 1.5
                                                                        // End of Thursday: 35, 2, 0 (Working)
                                                                        // End of Monday: 50, 0, 17 (Not working)

    public static final PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(20, 0, 2);
    ...
    public static double TRACK_WIDTH = 18.5; // This is weird, should be 14 I think, but tuner got this value and it works
